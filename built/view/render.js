...
var Render = /** @class */ (function () {
    ...
    Render.prototype.getMxn = function () { return this.mxn; };
    Render.prototype.setQuill = function (quill) {
        this.quill = quill;
        return this;
    };
    Render.prototype.getQuill = function () { return this.quill; };
    Render.prototype.setConfig = function (config) {
        this.config = config;
        return this;
    };
    Render.prototype.getConfig = function () { return this.config; };
    ...
    Render.prototype.renderKeySign = function (fifths, mode, clefSign, clefLine) {
        ...
        pos.forEach(function (p) {
            // TODO
            _this.quill.drawTransp(_this.posX, _this.posY - (p - 1) * _this.config.LineSpace, Constant.SHARP);
        });
        this.step();
    };
