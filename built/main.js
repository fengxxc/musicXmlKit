(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./parse", "./model/node", "./mxNodeRender", "./model/sorePartWiseNode", "./model/noteNode"], factory);
    }
    ...
    var root = parse_1.Parser.parseXml(xml, function (parent, tag, attrs) {
        ...
        switch (tag) {
            case 'score-partwise':
                ...
                break;
            case 'note':
                res = new noteNode_1.NoteNode(parent, tag, attrs);
                break;
            default:
    ...
    console.log(spn);
    var n1 = spn.getChildNodesByName('part')[0].getChildNodesByName('measure')[0].getChildNodesByName('note')[0];
