(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./parse", "./mxNodeRender"], factory);
    }
    ...
    function main() {
        var root = parse_1.Parser.parseXml(xml);
        console.dir(root);
    }
    main();
    new mxNodeRender_1.MxNodeRender().iterNode(parse_1.Parser.parseXml(xml));
    console.log(parse_1.Parser.parseXml(xml).getFullText());
});
