(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./model/parse", "./model/node", "./mxNodeRender", "./model/sorePartWiseNode", "./model/noteNode", "./model/measureNode"], factory);
    }
    ...
    var root = parse_1.Parser.parseXml(xml, function (parent, tag, attrs) {
        ...
        switch (tag) {
            case 'score-partwise':
                ...
                break;
            case 'measure':
                res = new measureNode_1.MeasureNode(parent, tag, attrs);
                break;
            case 'note':
